#!/usr/bin/python2
#coding=utf-8
#The Credit For This Code Goes To SAIFULLAH KHAN
...
logo = """
\033[1;95m     |-------+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-----|
\033[1;95m     |                 ☠️ SK CYBER ☠️                  |
\033[1;95m     |This Tool is Only for Pakistani FB Accounts|
\033[1;95m     |------+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+------|

\033[1;97m           [⚡\033[1;97mAuthor Name: SAIFULLAH KHAN  ☠️   ⚡\033[1;97m]
\033[1;97m           [⚡\033[1;97mwhatsapp Numbr: +923109487886 ⚡\033[1;97m]
\033[1;97m           [⚡\033[1;97mFACEBOOK ID: ksaif112 ⚡\033[1;97m]
\033[1;97m           [⚡       \033[1;97mFrom: PAKISTAN (SWABI)     ⚡\033[1;97m]
"""
...
────────────────────────────────
      ...
      \033[1;95m╚═══╝──╚╝──╚═══╝╚═══╝╚╝╚═╝
        ...
        \033[1;95mCEO SAIFULLAH KHAN master of HACKERs
\033[1;91m•──────────────────────────•
\033[1;91mNote: \033[1;97mWelcome to SK CYBER TOOL 
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:SK CYBER
	    time.sleep(2)
            loop = 'false'
        else:
...
def pilih_login():
	peak = raw_input("\n\033[1;96mChoose an Option(token is best option): \033[1;95m")
	if peak =="":
...
def login1():
	...
	try:
		...
		jalan(' \034[1;91mDSCLMER: \033[1;92mSK will not resposible of any ilgle activity ' )
...
def menu():
	...
	print "\033[1;97m[3]\x1b[1;96mJoin SK CYBER Whatsapp Group"
	print "\033[1;97m[4]\x1b[1;96mContact With ☠️SAIFULLAH KHAN☠️On Facebook"
	print "\033[1;97m[5]\x1b[1;96mjoin my facebook helping Group" 
	print "\033[1;97m[0]\033[1;96mExit            "
	pilih()
...
def pilih():
	...
	if unikers =="":
		...
		os.system('xdg-open https://chat.whatsapp.com/KP40mCS6APhEbg0yQHdhO7')
	        menu()
        elif unikers =="4":
		os.system('xdg-open https://facebook.com/ksaif112')
	        menu()
	elif unikers =="5":
		os.system('xdg-open https://www.facebook.com/groups/saifullahkhankhtk/?ref=share')
	        menu()		
	elif unikers =="0":
		jalan('Token Removed')
		os.system('rm -rf login.txt')
...
def pilih():
	...
	if unikers =="":
		...
		os.system('xdg-open ttps://chat.whatsapp.com/KP40mCS6APhEbg0yQHdhO7')
	        menu()
        elif unikers =="4":
		os.system('xdg-open https://facebook.com/ksaif112')
	        menu()
...
def pilih_super():
	...
	if peak =="":
		...
		os.system('clear')
		print "\033[1;95m«-----------------\033[1;91mSK CYBER\033[1;95m-----------------»"
		print logo
